require 'fuzzbert'
require '/mnt/c/Users/ngtro/github-classroom/Service-Design-Studio/final-project-group-5-amadeus/app/models/concerns/zero_shot_categoriser.rb'

fuzz "tag" do
    
  deploy do |data|
    begin
      ZeroShotCategoriser.request(data)
      ZeroShotCategoriser.get_body_request(data)
